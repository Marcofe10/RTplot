...
//     this->incTagAxesValue = 0;
    ...
    char s[4][80];
    sprintf(s[0], "Max:%.4f", this->vievedMaxValue);//Corresponds to max value
    sprintf(s[1], "Min:%.4f", this->vievedMinValue);//Corresponds to min value
    sprintf(s[2], "Pres:%d", this->insertsValues);//Corresponds to insertsValues
    sprintf(s[3], "SampSec:%d", this->samplePerSecond);//Corresponds to insertsValues
